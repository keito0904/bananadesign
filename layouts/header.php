<nav class="top-nav <?php if( is_page( array('about','service')) || is_home() || is_single() ) { echo 'shadow'; }else{} ?>">
  <ul class="content">
    <li class="logo">
    ...
    <li class="list-border"></li>
    <li>
      <a href="<?php bloginfo('url'); ?>/blog" class="nav-link <?php if ( is_home() || is_single() ) { echo 'active'; } ?>">ブログ</a>
    </li>
    <li class="list-border"></li>
    <div class="clear"></div>
  </ul>
